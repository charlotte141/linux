...
useradd carlos -m -s /bin/bash -p $(openssl passwd admin123) -G GRP_ADM 
useradd maria -m -s /bin/bash -p $(openssl passwd admin123) -G GRP_ADM
useradd joao -m -s /bin/bash -p $(openssl passwd admin123) -G GRP_ADM
